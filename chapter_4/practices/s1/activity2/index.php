...
$database = 'myclasspnv25'; // Name of the database you use (you need first to CREATE DATABASE in MySQL)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['username']) && !empty($_POST['message'])) :
    ...
    // cách 1:
    // $query = $db->prepare("INSERT INTO posts (name, message) VALUES (:username, :message)"); 
    // $query->bindParam(':username', $username);
    // $query->bindParam(':message', $message);
    // $query->execute();// TO DO: INSERT NEW POST IN DATABASE
